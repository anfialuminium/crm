            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 20px; margin-top: 20px;">
                <div>
                    ...
                    <div class="stepper-container">
                        ...
                        <input type="number" id="qty-${id}" class="stepper-input" value="1" min="1" inputmode="decimal" oninput="updateItemQty('${id}', this.value)" placeholder="כמות">
                        <button type="button" class="stepper-btn" onclick="accStepQty('${id}', 1)">+</button>
                    </div>
                </div>
                <div>
                    ...
                    <div class="stepper-container">
                        ...
                        <input type="number" class="stepper-input" value="" step="0.1" inputmode="decimal" oninput="updateItemPrice('${id}', this.value)" id="price-${id}" placeholder="מחיר">
                        <button type="button" class="stepper-btn" onclick="accStepPrice('${id}', 1)">+</button>
                    </div>
                </div>
            </div>
        ...
        if (product.product_name.includes('ידית משיכה')) {
            ...
            sizeContainer.innerHTML = `
                ...
                <div>
                    ...
                    <input type="number" step="0.1" class="input-big" id="size-input-${id}" inputmode="decimal" oninput="updateItemLength('${id}', this.value)" value="${item.length || 1}" placeholder="אורך">
                </div>
            `;
        } else if (isBrush) {
